...
export const fullGameRounds: RoundConfig[] = [
  ...
  },
  {
    ...
    description: 'Introduction to strategic bidding. With varying SRMCs across teams, the merit order creates natural winners and losers. Time to think strategically.',
    learningObjectives: [
  ...
  },
  {
    ...
    learningObjectives: [
      ...
      'Learn to bid hydro at expected clearing price, not SRMC',
