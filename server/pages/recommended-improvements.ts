/**
 * Recommended Further Improvements — Prioritised roadmap for the NEM Merit Order Game
...
<title>NEM Merit Order Game — Recommended Further Improvements</title>
<style>
...
<div class="container">
  ...
  <div class="header">
    ...
    <div class="subtitle">Prioritised roadmap for the NEM Merit Order Training Game</div>
  </div>
  ...
  <div style="margin-top: 3rem; padding: 1.5rem; text-align: center; color: #718096; font-size: 0.85rem; border-top: 1px solid #e2e8f0;">
    <p>NEM Merit Order Training Game &mdash; Recommended Further Improvements</p>
