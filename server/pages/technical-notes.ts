...
<title>NEM Merit Order Game — Technical Notes for IT Teams</title>
<style>
...
npm start</code></pre>
  ...
  <div style="margin-top: 3rem; padding: 1.5rem; text-align: center; color: #718096; font-size: 0.85rem; border-top: 1px solid #e2e8f0;">
    <p>NEM Merit Order Training Game &mdash; Technical Notes</p>
